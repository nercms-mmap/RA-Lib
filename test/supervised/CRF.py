...
if __name__ == '__main__':
    ...
    test_data = r"D:\RA_ReID\MovieLens1M\DatasetFiles\mlm-top20-test.csv"
    test_output_loc = 'D:\RA_ReID\Evaluation\m1m_result\result-CRF-mlm-top20-test.csv'

    with open(r'D:\RA_ReID\Evaluation\m1m_result\m1m_CRF.pkl', 'rb') as f:
        model = pickle.load(f)
    model.test(test_data, test_output_loc)